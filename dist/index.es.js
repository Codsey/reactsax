...
const RsIconClose = (_a) => {
    ...
    return React.createElement("i", { className: RsIconCloseClasses });
};
...
class RsAlert extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (React.createElement(Transition$1, { component: "span", in: active, timeout: 500, onEnter: (e) => this.beforeEnter(e), onEntering: (e) => this.enter(e), onExit: (e) => this.leave(e) },
            React.createElement("div", { className: alertClasses, ref: this.alertRef, style: {
                    "--rs-color": setComponentColor(color || "primary"),
                } },
                React.createElement(React.Fragment, null,
                    icon ? React.createElement("div", { className: "rs-alert__icon" }, icon) : null,
                    React.createElement("div", { className: titleClasses, onClick: toggleHiddenContent }, title),
                    closable ? (React.createElement("button", { className: "rs-alert__close" },
                        " ",
                        React.createElement(RsIconClose, { hover: "less" }))) : null,
                    React.createElement(Transition$1, { component: "span", in: !hiddenContent, timeout: 500, onEnter: (e) => this.beforeEnter(e), onEntering: (e) => this.enter(e), onExit: (e) => this.leave(e) },
                        React.createElement("div", { className: "rs-alert__content", ref: this.contentRef },
                            React.createElement("div", { className: "rs-alert__content__text" }, pagination ? pagination[page - 1] : children))),
                    footer ? React.createElement("div", { className: "rs-alert__footer" }, footer) : null,
                    pagination ? (React.createElement("div", { className: "rs-alert__pagination" },
                        React.createElement("button", { onClick: this.handleClickPrevPage },
                            " ",
                            "<",
                            " "),
                        React.createElement("span", null, `${page} / ${totalPages}`),
                        React.createElement("button", { onClick: this.handleClickNextPage }, ">"))) : null))));
    }
}
...
const RsAvatar = (_a) => {
    ...
    return (React.createElement("div", { ref: avatarRef, className: avatarContentClasses, style: {
        ...
        loading ? (React.createElement("div", { className: "rs-avatar__loading" },
            React.createElement("div", { className: "rs-avatar__loading__animate" }))) : null,
        React.createElement("div", { className: avatarClasses },
            text ? getText(text) : null,
            children),
        badge ? (React.createElement("div", { className: badgeClasses },
            " ",
            writing ? (React.createElement("div", { className: "rs-avatar__points" },
                React.createElement("div", { className: "rs-avatar__points__point" }),
                React.createElement("div", { className: "rs-avatar__points__point" }),
                React.createElement("div", { className: "rs-avatar__points__point" }))) : (badge))) : null,
        group && elIndex === max - 1 ? (React.createElement("div", { className: "rs-avatar__latest" },
            `+${avatarLength - elIndex - 1}`,
            " ")) : null,
        icon ? React.createElement("div", { className: "rs-avatar__icons" },
            " ",
            icon) : null));
};
...
const RsAvatarGroup = (_a) => {
    ...
    return (React.createElement("div", { className: avatarGroupClasses, "data-max": max }, children));
};
...
const RsButton = (_a) => {
    ...
    return (React.createElement("button", Object.assign({ className: buttonClasses, ref: buttonRef, onMouseDown: (e) => rippleEffect(e), style: {
            "--rs-color": setComponentColor(color || componentColor || "primary"),
        } }, rest),
        React.createElement("div", { className: "rs-button__content" }, children),
        loading ? React.createElement("div", { className: "rs-button__loading" }, " ") : null,
        animate ? React.createElement("div", { className: animateButtonClasses },
            animate,
            " ") : null));
};
...
const RsButtonGroup = (_a) => {
    ...
    return React.createElement("div", { className: 'rs-button-group' }, children);
};
...
const RsCard = (_a) => {
    ...
    return (React.createElement("div", { className: CardContentClasses },
        React.createElement("div", { className: "rs-card" },
            image ? (React.createElement("div", { className: "rs-card__img" },
                image,
                interactions ? (React.createElement("div", { className: "rs-card__interactions" }, interactions)) : null)) : null,
            text ? (React.createElement("div", { className: "rs-card__text" },
                title ? React.createElement("div", { className: "rs-card__title" }, title) : null,
                text)) : null,
            buttons ? React.createElement("div", { className: "rs-card__buttons" }, buttons) : null)));
};
...
const RsIconCheck = (_a) => {
    ...
    return (React.createElement("i", { className: checkIconClasses },
...
const RsCheckbox = (_a) => {
    ...
    return (React.createElement("div", { className: checkboxContentClasses, style: {
            "--rs-color": setComponentColor(color || "primary"),
        } },
        React.createElement("div", { className: "rs-checkbox-con" },
            React.createElement("input", Object.assign({ id: id.current, type: "checkbox", className: "rs-checkbox", checked: checked }, rest)),
            React.createElement("div", { className: "rs-checkbox-mask" },
                !icon ? React.createElement(RsIconCheck, { indeterminate: indeterminate }) : null,
                icon)),
        React.createElement("label", { htmlFor: id.current, className: checkboxLabelClasses }, children)));
};
...
const RsInput = (_a) => {
    ...
    return (React.createElement("div", { className: parentClasses, style: {
            "--rs-color": setComponentColor(color || ""),
        } },
        React.createElement("div", { className: inputContentClasses },
            React.createElement("input", Object.assign({ className: inputClasses, onChange: (e) => {
                    setValue(e.target.value);
                    onChange(e);
                }, type: type, value: value }, rest)),
            label ? (React.createElement("label", { className: placeholderClasses }, placeholder)) : null,
            React.createElement("label", { className: labelClasses }, label || placeholder || labelPlaceholder),
            icon ? (React.createElement("span", { className: iconClasses, onClick: iconClick }, icon)) : null,
            loading ? React.createElement("div", { className: "rs-input__loading" }) : null,
            React.createElement("div", { className: "rs-input__affects" },
                React.createElement("div", { className: "rs-input__affects__1" }),
                React.createElement("div", { className: "rs-input__affects__2" }),
                React.createElement("div", { className: "rs-input__affects__3" }),
                React.createElement("div", { className: "rs-input__affects__4" }))),
        progress > 0 ? (React.createElement("div", { className: progressClasses },
            React.createElement("div", { className: "rs-input__progress__bar", style: { width: `${progress}%` } }))) : null,
        React.createElement("div", null, message ? React.createElement("div", { className: messageClasses },
            " ",
            message) : null)));
};
...
const RsLoading = (_a) => {
    ...
    return (React.createElement(React.Fragment, null, isVisible ? (React.createElement("div", { className: visibleClasses, style: {
            "--rs-color": setComponentColor(color || "primary"),
        ...
        React.createElement("div", { className: "rs-loading__load", style: { transform: `scale(${scale})` } },
            React.createElement("div", { className: "rs-loading__load__animation" },
                React.createElement("div", { className: "rs-loading__load__percent" }, percent ? `${percent}%` : null),
                React.createElement("div", { className: "rs-loading__load__animation__1" }),
                React.createElement("div", { className: "rs-loading__load__animation__2" }),
                React.createElement("div", { className: "rs-loading__load__animation__3" })),
            React.createElement("div", { className: "rs-loading__load__text" }, text)),
        progress ? (React.createElement("div", { className: "rs-loading__progress" },
            React.createElement("div", { className: "rs-loading__progress__bar", style: { width: `${progress}%` } }))) : null)) : null));
};
...
const RsModal = (_a) => {
    ...
    return (React.createElement(CSSTransition$1, { timeout: 300, in: active, mountOnEnter: true, unmountOnExit: true, classNames: {
            enterActive: "rs-dialog-enter-active",
        } },
        React.createElement(React.Fragment, null, active ? (ReactDOM.createPortal(React.createElement("div", { className: dialogContentClasses, ref: dialogRef, onClick: (e) => {
            ...
            React.createElement("div", { className: dialogClasses },
                loading ? (React.createElement("div", { className: "rs-dialog__loading" },
                    React.createElement("div", { className: "rs-dialog__loading__load" }))) : null,
                !notClose ? (React.createElement("button", { className: "rs-dialog__close", onClick: () => handleInternalClose(dialogRef.current) },
                    React.createElement(RsIconClose, { hover: "x" }))) : null,
                React.createElement("header", { className: "rs-dialog__header" }, header),
                React.createElement("div", { className: dialogChildrenClasses }, children),
                React.createElement("footer", { className: "rs-dialog__footer" }, footer))), document.body)) : (React.createElement(React.Fragment, null)))));
};
...
const RsNavbar = (_a) => {
    ...
    return (React.createElement("div", { ref: NavbarRef, style: {
            "--rs-color": setComponentColor(color || ""),
        }, className: navbarContentClasses },
        React.createElement("div", { className: "rs-navbar" }, children)));
};
...
const RsNavbarGroup = (_a) => {
    ...
    return (React.createElement("div", { className: "rs-navbar__group" },
        React.createElement("button", { className: "rs-navbar__group__item" }, title),
        React.createElement("div", { className: "rs-navbar__group__items" }, children)));
};
...
const RsNotification = (_a) => {
    ...
    const destroyTimer = React.useRef(false);
    ...
    console.log(notificationRef);
    return (React.createElement(CSSTransition$1, { timeout: 100, in: isVisible, onEnter: beforeEnter, onEntered: enter, mountOnEnter: true, unmountOnExit: true, classNames: {
            enter: "notification-enter",
            enterActive: "notification-enter-active",
        } }, isVisible ? (React.createElement("div", { className: notificatinClasses, ref: notificationRef, style: {
            "--rs-color": setComponentColor(color || ""),
            "--rs-border": setComponentColor(border || ""),
        }, onMouseEnter: () => handleMouseEnter(), onMouseLeave: () => handleMouseLeave() },
        !loading && icon ? (React.createElement("div", { className: "rs-notification__icon" }, icon)) : null,
        !loading && !content ? (React.createElement("div", { className: "rs-notification__content" },
            title ? (React.createElement("div", { className: "rs-notification__content__header" },
                React.createElement("h4", null, title))) : null,
            text ? (React.createElement("div", { className: "rs-notification__content__text" },
                React.createElement("p", null, text))) : null)) : null,
        !loading && content ? (React.createElement("div", { className: "rs-notification__content" },
            React.createElement("div", { className: "rs-notification__content__header" }, title),
            React.createElement("div", { className: "rs-notification__content__text" }, text),
            content)) : null,
        closeButton ? (React.createElement("button", { className: "rs-notification__close", onClick: forceDestroy },
            React.createElement(RsIconClose, { hover: "less" }))) : null,
        loading ? React.createElement("div", { className: "rs-notification__loading" }, " ") : null)) : (React.createElement(React.Fragment, null))));
};
...
const RsIconArrow = (_a) => {
    __rest(_a, []);
    return React.createElement("i", { className: 'rs-icon-arrow' });
};
...
const RsPagination = (_a) => {
    ...
    const renderDotted = (text = "...", index) => {
        ...
        return (React.createElement("div", { className: dottedClasses, key: index, onClick: () => {
            ...
            React.createElement("span", { className: "dotted" }, "..."),
            React.createElement("span", { className: "con-arrows" },
                React.createElement(RsIconArrow, null),
                React.createElement(RsIconArrow, null))));
    };
    const renderButton = (NumberPage = 1, index) => {
        ...
        return (React.createElement("button", { ref: (el) => (buttonRefs.current[`btn${NumberPage}`] = el), className: buttonClasses, onClick: () => setValue(NumberPage), key: index }, buttonsDotted ? "" : `${NumberPage}`));
    };
    ...
    return (React.createElement("div", { style: {
        ...
        !onlyArrows && !children ? (React.createElement("div", { className: paginationActiveClasses, style: { left: `${leftActive}px` } }, buttonsDotted ? "" : value)) : null,
        !notArrows ? (React.createElement("button", { className: "rs-pagination__arrow prev", disabled: infinite ? false : value <= 1, onClick: () => {
            ...
            } }, arrowPrev ? arrowPrev : React.createElement(RsIconArrow, null))) : null,
        children ? (React.createElement("div", { className: "rs-pagination__slot" },
            " ",
            children,
            " ")) : null,
        !onlyArrows && !children ? (React.createElement("div", { ref: paginationRef, className: "rs-pagination" }, getPages().map((page) => page))) : null,
        !notArrows ? (React.createElement("button", { className: "rs-pagination__arrow next", disabled: infinite ? false : value >= length, onClick: () => {
                // const newVal = value + 1;
                // if (newVal <= length) {
                //   setValue(newVal);
                // } else if (infinite) {
                ...
                // }
                setNextValue();
            } }, arrowNext ? arrowNext : React.createElement(RsIconArrow, null))) : null,
        progress ? (React.createElement("div", { className: "rs-pagination__progress" },
            React.createElement("div", { className: "progress", style: { width: `${getProgress()}%` } }))) : null));
};
...
const RsRadio = (_a) => {
    ...
    return (React.createElement("div", { className: radioContentClasses, style: {
            '--rs-color': setComponentColor(color || 'primary')
        } },
        labelBefore ? (React.createElement("label", { htmlFor: id.current, className: 'rs-radio__label' }, labelBefore)) : null,
        React.createElement("div", { className: 'rs-radio' },
            React.createElement("input", Object.assign({ type: 'radio', value: value, name: name || active, checked: isChecked(), id: id.current }, rest)),
            React.createElement("span", { className: 'rs-radio__effect' },
                React.createElement("span", { className: 'rs-radio__effect__icon' }, icon),
                React.createElement("span", { className: 'rs-radio__effect__loading' }))),
        label ? (React.createElement("label", { htmlFor: id.current, className: 'rs-radio__label' }, label)) : null));
};
...
const RsSidebar = (_a) => {
    ...
    return (React.createElement("div", { className: SidebarContentClasses, ref: SidebarRef, onMouseEnter: () => {
        ...
        logo ? React.createElement("div", { className: "rs-sidebar__logo" }, logo) : null,
        header ? React.createElement("div", { className: "vs-sidebar__header" }, header) : null,
        React.createElement("div", { className: "rs-sidebar" }, children),
        footer ? React.createElement("div", { className: "rs-sidebar__footer" }, footer) : null));
};
...
const RsSidebarGroup = (_a) => {
    ...
    return (React.createElement("div", { className: SidebarGroupClasses },
        React.createElement("div", { className: "rs-sidebar__group__header", onClick: () => setOpen((prevState) => !prevState) }, header),
        React.createElement(Transition$1, { component: "div", in: open, mountOnEnter: true, timeout: 100, onEnter: (e) => beforeEnter(e), onEntered: (e) => enter(e), onExit: (e) => leave(e) },
            React.createElement("div", { className: "rs-sidebar__group__content" }, children))));
};
...
const RsSidebarItem = (_a) => {
    ...
    return (React.createElement("button", { className: SidebarItemClasses },
        icon ? React.createElement("div", { className: "rs-sidebar__item__icon" }, icon) : null,
        React.createElement("div", { className: "rs-sidebar__item__text" }, children),
        React.createElement("div", { className: "rs-sidebar__item__text-tooltip" }, children),
        arrow ? (React.createElement("div", { className: "rs-sidebar__item__arrow" },
            React.createElement(RsIconArrow, null))) : null));
};
...
const RsSwitch = (_a) => {
    ...
    return (React.createElement("div", { className: switchClasses, style: {
            "--rs-color": setComponentColor(color || "primary"),
        } },
        React.createElement("input", Object.assign({ type: "checkbox", className: "rs-switch__input", checked: isChecked.current || checked }, rest)),
        React.createElement("div", { className: "rs-switch__circle" },
            " ",
            circle,
            " "),
        React.createElement("div", { className: "rs-switch__text on" }, switchOn ? switchOn : children),
        React.createElement("div", { className: "rs-switch__text off" }, switchOff ? switchOff : children),
        React.createElement("div", { className: "rs-switch__background" })));
};
...
const RsTable = (_a) => {
    ...
    return (React.createElement("div", { className: "rs-table-content" },
        header ? React.createElement("header", { className: "rs-table__header" }, header) : null,
        React.createElement("div", { className: tableDivClasses },
            React.createElement("table", null,
                React.createElement("thead", { ref: theadRef, className: "rs-table__thead" }, children.filter((obj) => obj.props.thead)),
                React.createElement("tbody", { className: "rs-table__tbody" }, children.filter((obj) => !obj.props.thead)),
                notFound ? (React.createElement("tbody", { className: "rs-table_not-found" },
                    React.createElement("tr", null,
                        React.createElement("td", null, notFound || "No matching records found")))) : null)),
        footer ? React.createElement("footer", { className: "rs-table__footer" }, footer) : null));
};
...
const RsTableTd = (_a) => {
    ...
    return React.createElement("td", { className: RsTdClasses }, children);
};
...
const RsTableTh = (_a) => {
    ...
    return (React.createElement("th", { className: tableThClasses },
        React.createElement("div", { className: "rs-table__th__content" },
            children,
            sort ? (React.createElement("div", { className: "rs-table__th__content__icons" },
                React.createElement(RsIconArrow, { className: "icon-sort-1" }),
                React.createElement(RsIconArrow, { className: "icon-sort-2" }))) : null)));
};
...
const RsTooltip = (_a) => {
    ...
    const tooltipContent = React.createRef();
    ...
    return (React.createElement("div", { className: 'rs-tooltip-content', ref: tooltipContent, onMouseEnter: e => {
            if (!notHover) {
                handleMouseEnter();
            }
        }, onMouseLeave: () => {
        ...
        activeTooltip ? (ReactDOM.createPortal(React.createElement("div", { className: tooltipClasses, ref: tooltipRef, style: {
                '--rs-color': setComponentColor(color || '')
            }, onMouseEnter: () => {
                if (interactivity) {
            ...
            tooltip,
            loading ? React.createElement("div", { className: 'rs-tooltip__loading' }) : null), document.body)) : (React.createElement(React.Fragment, null)),
        children));
};

export { Notification, RsAlert, RsAvatar, RsAvatarGroup, RsButton, RsButtonGroup, RsCard, RsCheckbox, RsInput, RsLoading, RsModal, RsNavbar, RsNavbarGroup, RsNavbarItem, RsPagination, RsRadio, RsSidebar, RsSidebarGroup, RsSidebarItem, RsSwitch, RsTable, RsTableTd, RsTableTh, RsTableTr, RsTooltip };
